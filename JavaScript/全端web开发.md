...
![https响应和请求](../Image/https响应和请求.png)
...
![JavaScript 语法继承关系](../Image/JavaScript 语法继承关系.png)
...
![HTTP 1.1 中和 REST 有关的选项清单](../Image/HTTP 1.1 中和 REST 有关的选项清单.png)
...
![服务器类型](../Image/服务器类型.png)

![软件成熟度模型](../Image/软件成熟度模型.png)
