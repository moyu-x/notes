...
![Flask-Bootstrap基模板中定义的块1](imgs/flask-web/Flask-Bootstrap基模板中定义的块1.png)
...
![WTForms支持的HTML标准字段](imgs/flask-web/WTForms支持的HTML标准字段.png)
...
![常用的SQLAlchemy关系选项1](imgs/flask-web/常用的SQLAlchemy关系选项1.png)
